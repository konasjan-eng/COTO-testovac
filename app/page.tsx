...
export default function Home() {
  ...
  if (entryStage === "icon") return <main className="entry-screen"><button className="coto-entry-icon" onClick={() => setEntryStage("logo")} aria-label="Otevřít COTO"><span className="icon-question">?</span><span className="icon-head icon-head-left">C<span>●</span></span><span className="icon-head icon-head-right">O<span>●</span></span><span className="icon-smile">☺</span><b>COTO</b></button></main>;
