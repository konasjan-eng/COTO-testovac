...
export default function Home() {
  ...
  if (entryStage === "icon") return <main className="entry-screen"><button className="coto-entry-icon video-look" onClick={() => setEntryStage("logo")} aria-label="Otevřít COTO"><img src="/COTO-testovac/coto-icon-video.svg" alt="Ikona COTO – otevřít aplikaci" /><span>KLIKNUTÍM OTEVŘÍT COTO</span></button></main>;
  if (entryStage === "logo") return <main className="entry-screen"><button className="coto-entry-logo coto-entry-logo-image" onClick={() => setEntryStage("roles")} aria-label="Pokračovat z loga COTO k volbě role"><img src="/COTO-testovac/coto-logo-video.svg" alt="COTO – Co/dáš a To/máš, aplikace pro spravedlivou výměnu informací" /><span className="logo-continue">KLIKNUTÍM POKRAČUJTE</span></button></main>;
